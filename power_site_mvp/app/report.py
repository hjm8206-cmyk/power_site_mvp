...
def markdown_report(analysis: Dict[str, Any], manual: Any, towers: List[Any], privacy: bool = False) -> str:
    ...
    lines = [
        ...
        *area_block_lines,
        ...
        f"- 판정: {'대용량 수전형 데이터센터 검토 불가' if area_blocked else _grade_decision(score.get('final_grade', score.get('grade')))}",
...
def markdown_report(analysis: Dict[str, Any], manual: Any, towers: List[Any], privacy: bool = False) -> str:
    ...
    score_rows = [
        ...
        ("판정", "대용량 수전형 데이터센터 검토 불가" if area_blocked else _grade_decision(score.get("final_grade", score.get("grade")))),
    ...
    lines = [
        ...
        *table(
            [
                ...
                ("농림지역 감점", f"-{value(metrics.get('agricultural_penalty'), '0')}"),
